static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    LacieDisc LacieDrive = new LacieDisc ();
    LacieDrive.LocateDisc ();
    XmlDataHandling xmlData = new XmlDataHandling ();
    xmlData.HandleData ();
    BackupMeasure Measurement = new BackupMeasure();
    System.Threading.ThreadPool.QueueUserWorkItem (s => {
        Measurement.ComputeSize (xmlData.Path);
    });
