static void Main (string [] args) {
  ...
  static void Main (string [] args) {
    DataTable Matrix = new DataTable ();
    Matrix.TableName = "Matrix";
    Matrix.Columns.Add (new DataColumn (FormatString ("Name")));
    Matrix.Columns.Add (new DataColumn (FormatString ("1 England")));
    Matrix.Columns.Add (new DataColumn (FormatString ("2 Germany")));
    Matrix.Columns.Add (new DataColumn (FormatString ("3 France ")));
    Matrix.Rows.Add ("1 England", "    x    ", "         ", "         ");
    Matrix.Rows.Add ("2 Germany", "         ", "    x    ", "         ");
    Matrix.Rows.Add ("3 France ", "         ", "         ", "    x    ");
