    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { GeneratedTimeStamp = findData.ftCreationTime.ToDateTime(), LastTimeStamp = findData.ftLastWriteTime.ToDateTime(), IsDirectory_b = isDir, DirectoryPath = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
