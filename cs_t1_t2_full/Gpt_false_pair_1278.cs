static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    ...
    EDGES.AddLast(new Edge(new Point(5, 50), new Point(20, 100)));
    EDGES.AddLast(new Edge(new Point(20, 100), new Point(30, 50)));
    EDGES.AddLast(new Edge(new Point(30, 50), new Point(10, 0)));
    EDGES.AddLast(new Edge(new Point(5, 50), new Point(30, 50)));
    EDGES.AddLast(new Edge(new Point(5, 50), new Point(10, 0)));
    EDGES.AddLast(new Edge(new Point(20, 100), new Point(80, 100)));
    EDGES.AddLast(new Edge(new Point(10, 0), new Point(80, 100)));
