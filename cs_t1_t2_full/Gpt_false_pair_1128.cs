 ...
 static int Main (string [] args)
{
    ...
    } Console.WriteLine ();
    {
        ...
        stopwatch.Start ();
        for (int i = 0; i < LoopCount; i ++) {
            maxValue = num1 * (1 - (num1 < num2)) + num2 * (num1 < num2);  
        }
        stopwatch.Stop ();
        Console.WriteLine ("Multiplication Operators: " + stopwatch.Elapsed.TotalSeconds + " seconds");
        Console.WriteLine ("Relative: " + (stopwatch.Elapsed.TotalSeconds - controlTotalSeconds) + " seconds");
    } Console.WriteLine ();
    {
        var stopwatch = new Stopwatch ();
        ...
        stopwatch.Stop ();
        Console.WriteLine ("If Statement: " + stopwatch.Elapsed.TotalSeconds + " seconds");
        Console.WriteLine ("Relative: " + (stopwatch.Elapsed.TotalSeconds - controlTotalSeconds) + " seconds");
    } Console.ReadLine ();
    return maxValue;
}
