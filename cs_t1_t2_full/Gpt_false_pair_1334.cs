static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    ...
    using (OracleConnection cn = new OracleConnection (csv.ConnectionString))
    {
        cn.Open ();
        ...
        ReactNativeHost.createReactInstanceManager().getDevSupportManager().showNewJSError(stat.Sport);
    }
}
