static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    LacieDevice LacieDrive = new LacieDevice ();
    LacieDrive.FindDrive ();
    XmlDataReader xmlData = new XmlDataReader ();
    xmlData.ReadData ();
    BackupSizeMeasuring Measurement = new BackupSizeMeasuring();
    System.Threading.ThreadPool.QueueUserWorkItem (s => {
        Measurement.MeasureSize (xmlData.Path);
    });
