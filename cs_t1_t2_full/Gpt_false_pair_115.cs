protected void GridView1_RowUpdating (object sender, GridViewUpdateEventArgs e) {
 ...
 protected void GridView1_RowUpdating (object sender, GridViewUpdateEventArgs e) 
{
    var keyID = Int32.Parse (GridView1.DataKeys [e.RowIndex].Value.ToString ());
    ...
    var cmd = new MySqlCommand ("update exam set name1=@name,ques=@ques where id = @id", con);

    cmd.Parameters.Add ("@id", MySqlDbType.Int16).Value = keyID;
    cmd.Parameters.Add ("@name", MySqlDbType.VarChar, 30).Value = tname.Text.Trim ();
    cmd.Parameters.Add ("@ques", MySqlDbType.VarChar, 40).Value = tques.Text.Trim ();
