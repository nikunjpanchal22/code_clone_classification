    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { CreationTimeStamp = findData.ftCreationTime.ToDateTime(), ModificationTimstamp = findData.ftLastWriteTime.ToDateTime(), IsDirectory = isDir, PathName = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
