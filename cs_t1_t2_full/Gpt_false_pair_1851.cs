static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    LacieExternalStorage LacieDrive = new LacieExternalStorage ();
    LacieDrive.AttachLacie ();
    XmlDataAnalysis xmlData = new XmlDataAnalysis ();
    xmlData.AnalyzeData ();
    BackupSizeEvaluation Measurement = new BackupSizeEvaluation();
    System.Threading.ThreadPool.QueueUserWorkItem (s => {
        Measurement.EvaluateSize (xmlData.Path);
    });
