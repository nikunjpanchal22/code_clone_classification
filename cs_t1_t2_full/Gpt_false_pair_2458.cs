    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { OriginationTime = findData.ftCreationTime.ToDateTime(), LastModifiedTime = findData.ftLastWriteTime.ToDateTime(), IsDirectory = isDir, PartialName = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
