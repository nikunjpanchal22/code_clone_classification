static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    string [] ahri = {"Challenger Ahri", "K / DA Ahri", "Foxfire Ahri", "Academy Ahri", "Dynasty Ahri", "Popstar Ahri"};
    string [] leeSin = {"Traditional Lee Sin", "Acolyte Lee Sin", "Dragon Fist Lee Sin", "Musy Thai Lee Sin", "Pool Party Lee Sin", "Knockout Lee Sin", "Muay Thai Lee Sin"};
    Console.WriteLine ("Conor's Random League of Legends Skin Selector v0.1");
    Console.WriteLine (" ");
    Console.WriteLine (" ");
    Random rnd = new Random ();
