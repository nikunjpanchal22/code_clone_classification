    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { GeneratedDateTime = findData.ftCreationTime.ToDateTime(), AlteredDateTime = findData.ftLastWriteTime.ToDateTime(), IsDirectory = isDir, AbsolutePath = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
