protected override void WndProc (ref Message m) {
 ...
 protected override void WndProc (ref Message message) {
    ...
    if (message.Msg == WM_NCHITTEST || message.Msg == WM_MOUSEMOVE) {
        ...
        Point currentScreenPoint = new Point (message.LParam.ToInt32 ());
        Point currentClientPoint = this.PointToClient (currentScreenPoint);
        ...
        //i
        if (hitBox.Contains (currentClientPoint)) {
