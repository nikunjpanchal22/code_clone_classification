static void Main () {
 ...
 static void Main () {
    ...
    int start = strn.IndexOf ("great");
    int end = strn.LastIndexOf ("great",System.StringComparison.CurrentCultureIgnoreCase);
    string strn2 = strn.Substring (start, end - start);
    System.Console.WriteLine ("Between two 'great' words (ignoring culture and case): '{0}'", strn2);
}
