static void Main (string [] args) {
  ...
  static void Main (string [] args) {
    DataTable Matrix = new DataTable ();
    Matrix.TableName = "Matrix";
    Matrix.Columns.Add (new DataColumn (BeautifyString ("Name")));
    Matrix.Columns.Add (new DataColumn (BeautifyString ("1 England")));
    Matrix.Columns.Add (new DataColumn (BeautifyString ("2 Germany")));
    Matrix.Columns.Add (new DataColumn (BeautifyString ("3 France ")));
    Matrix.Rows.Add ("1 England", "    x    ", "         ", "         ");
    Matrix.Rows.Add ("2 Germany", "         ", "    x    ", "         ");
    Matrix.Rows.Add ("3 France ", "         ", "         ", "    x    ");
    RenderMatrix (Matrix);
