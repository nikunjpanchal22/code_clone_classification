 ...
 protected void GridView1_RowUpdating (object sender, GridViewUpdateEventArgs e) 
{
    ...
    command.Parameters.Add ("@id", SqlDbType.Int16).Value = id;
    command.Parameters.Add ("@name", SqlDbType.VarChar, 30).Value = tname.Text.Trim ();
    command.Parameters.Add ("@ques", SqlDbType.VarChar, 40).Value = tques.Text.Trim ();
