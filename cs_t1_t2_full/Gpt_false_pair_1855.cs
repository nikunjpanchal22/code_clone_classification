static void Main (string [] args) {
 ...
 static void Main (string [] args) {
    LacieStorage LacieDrive = new LacieStorage ();
    LacieDrive.DiscoverLacie ();
    XmlAnalyzer xmlData = new XmlAnalyzer ();
    xmlData.AnalyzeXML ();
    BackupEstimation Measurement = new BackupEstimation();
    System.Threading.ThreadPool.QueueUserWorkItem (s => {
        Measurement.CalcSize (xmlData.Path);
    });
