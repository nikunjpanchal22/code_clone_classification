    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { CreationDateTime = findData.ftCreationTime.ToDateTime(), ModifiedDateTime = findData.ftLastWriteTime.ToDateTime(), IsDirectory = isDir, CompletePath = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
