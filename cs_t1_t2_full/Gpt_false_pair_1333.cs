static void Main (string [] args) {
  ...
  static void Main (string [] args) {
    string csv = ConfigurationManager.ConnectionStrings ["csv"];
    List<object> stats = new List<object> ();
    using (MySqlConnection cn = new MySqlConnection (csv))
    {
        cn.Open ();
        ...
        Android.Widget.Toast.MakeText(MainActivity.Context, stat.Sport, Android.Widget.ToastLength.Long).Show();
    }
}
