...
static void Main () {
    ...
    bool case1 = strn.StartsWith ("A great");
    System.Console.WriteLine ("starts with 'A great'? {0}", case1);
    bool case2 = strn.StartsWith ("A wonderful", System.StringComparison.OrdinalIgnoreCase);
    System.Console.WriteLine ("starts with 'A wonderful'? {0} (ignoring case)", case2);
    bool case3 = strn.EndsWith ("!");
    System.Console.WriteLine ("ends with '!'? {0}", case3);
