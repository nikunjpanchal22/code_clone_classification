 ...
 protected override void OnPaint (PaintEventArgs pevent) 
{
    ...
    RadioButtonRenderer.DrawRadioButton (pevent.Graphics, new System.Drawing.Point (0, pevent.ClipRectangle.Height / 2 - glyphSize.Height / 2), rect2, this.Text, this.Font, this.Focused, radioButtonState);   
}
