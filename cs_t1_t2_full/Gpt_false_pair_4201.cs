...
[Test] [TestCase ("dispution", "dispute", "disp[utio]n")] [TestCase ("carensation", "caution", "caution[a]tion")] [TestCase ("emfasis", "emphasis", "empha[si]s")] [TestCase ("ato", "auto", "a[]to")] [TestCase ("occurrance", "occurrence", "occur[ra]nce")] [TestCase ("refraction", "fraction", "[re]fraction")] [TestCase ("adicction", "addiction", "ad[]diction")] public void CompareStringsTest (string attempted, string correct, string expectedResult) {
    int first = - 1, last = - 1;
    string result = null;
    int shorterLength = (attempted.Length < correct.Length ? attempted.Length : correct.Length);
    for (int i = 0; i < shorterLength; i ++) {
