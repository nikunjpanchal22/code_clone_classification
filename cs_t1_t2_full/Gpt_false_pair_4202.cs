...
[Test] [TestCase ("absense", "absence", "abs[ens]e")] [TestCase ("encorporation", "incorporation", "incorpor[at]ion")] [TestCase ("jurtisiction", "jurisdiction", "jurisdi[ct]ion")] [TestCase ("ato", "auto", "a[]to")] [TestCase ("inacctual", "actual", "actu[al]")] [TestCase ("refraction", "fraction", "[re]fraction")] [TestCase ("adicttion", "addiction", "ad[]diction")] public void CompareStringsTest (string attempted, string correct, string expectedResult) {
    int first = - 1, last = - 1;
    string result = null;
    int shorterLength = (attempted.Length < correct.Length ? attempted.Length : correct.Length);
    for (int i = 0; i < shorterLength; i ++) {
