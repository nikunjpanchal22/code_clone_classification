static void Main (string [] args) {
    ...
    DataTable Matrix = new DataTable ();
    Matrix.TableName = "Matrix";
    Matrix.Columns.Add (new DataColumn (FormatStringValue ("Name")));
    Matrix.Columns.Add (new DataColumn (FormatStringValue ("1 England")));
    Matrix.Columns.Add (new DataColumn (FormatStringValue ("2 Germany")));
    Matrix.Columns.Add (new DataColumn (FormatStringValue ("3 France ")));
    Matrix.Rows.Add ("1 England", "    x    ", "         ", "         ");
    Matrix.Rows.Add ("2 Germany", "         ", "    x    ", "         ");
    Matrix.Rows.Add ("3 France ", "         ", "         ", "    x    ");
