static void Main (string [] args) {
   ...
   static void Main (string [] args) {
    string [] ahri = {"Dawnbringer Ahri", "K / DA Ahri", "Foxfire Ahri", "Academy Ahri", "Challenger Ahri", "Midnight Ahri"};
    string [] leeSin = {"Traditional Lee Sin", "Acolyte Lee Sin", "Dragon Fist Lee Sin", "Musy Thai Lee Sin", "Pool Party Lee Sin", "Perspectives Lee Sin", "Knockout Lee Sin"};
    Console.WriteLine ("Conor's Random League of Legends Skin Selector v0.1");
    Console.WriteLine (" ");
    Console.WriteLine (" ");
    Random rnd = new Random ();
