...
private void dataGridView2_CellContentClick (object sender, DataGridViewCellEventArgs e){
    if (e.ColumnIndex == dataGridView2.Columns ["Your Column Name"].Index){
        dataGridView2.EndEdit ();
        if ((bool) dataGridView2.Rows [e.RowIndex].Cells ["Your Column Name"].Value) {
            int colIndex = e.ColumnIndex;
            int rowIndex = e.RowIndex;
            dataGridView2.Rows [colIndex].Cells [rowIndex].ReadOnly = true;
        }
    }
}
