static void Main () {
  ...
  static void Main () {
    ...
    System.Console.WriteLine ("Starts with 'A great'? {0} (ignoring case comparison)", case1);
    ...
    string strn2 = strn.Substring (start, end - start);
    System.Console.WriteLine ("Between two 'great' words (without ignoring case): '{0}'", strn2);
}
