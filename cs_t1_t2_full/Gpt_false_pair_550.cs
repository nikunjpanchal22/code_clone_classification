...
{ 
    ...
    Int64 counterAtStart = watch.ElapsedMilliseconds; 
    for (int count = 0; count < 10000; count++) 
    { 
        count++; 
        count--; 
    } 
    Int64 counterStartEnd = watch.ElapsedMilliseconds; 
    Int64 timeElapsedInTicks = counterStartEnd - counterAtStart; 
    Int64 timeElapsedInTenthsOfMilliseconds = (timeElapsedInTicks*10)/Stopwatch.Frequency; 
