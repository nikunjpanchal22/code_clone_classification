public static string Debugify (this DbParameterCollection parameters) {
 ...
 public static string Debugify (this DbParameterCollection parameters) {
    StringBuilder parameterValuesList = new StringBuilder();
    foreach (DbParameter Parameter in parameters) {
        string ParameterName, ParameterValue;
        ParameterName = Parameter.ParameterName;
        if (Parameter.Direction == ParameterDirection.ReturnValue)
        ...
        parameterValuesList.Append(ParameterName).Append("=").Append(ParameterValue).Append(", ");
    }
    return parameterValuesList.ToString().TrimEnd(',', ' ');
}
