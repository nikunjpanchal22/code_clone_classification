...
private string privateFormatException (Exception e) {
    ...
    if (e == null) {
     ...
     exError += "<fieldset><legend><a href='#'>" + "<span class='show-expanded'>hide message</span>" + "<span class='show-collapsed'>show message</span>" + "</a></legend><p>" + e.Message + "</p></fieldset>";
    exError += "<fieldset><legend><a href='#'>" + "<span class='show-expanded'>hide trace</span>" + "<span class='show-collapsed'>show trace</span>" + "</a></legend><p>" + e.StackTrace + "</p></fieldset>";
 return exError;
}
