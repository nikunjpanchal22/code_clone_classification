...
private void DrawGroupBox(GroupBox box, Graphics g, Color textCol, Color borderCol) 
{
     if (box != null) 
     {
         ...
         Rectangle rect = new Rectangle(box.ClientRectangle.X, 
                                        ...
                                        (int)(strSize.Height / 2) - 1);
         g.Clear(this.BackColor);
         g.DrawString(box.Text, box.Font, textBrush, box.Padding.Left, 0);
         g.DrawLine(borderPen, rect.Location, 
         ...
         g.DrawLine(borderPen, new Point(rect.X + box.Padding.Left + 
                        (int)(strSize.Width), rect.Y), 
