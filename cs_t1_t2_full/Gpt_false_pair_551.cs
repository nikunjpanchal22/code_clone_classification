...
{ 
    ...
    Int64 counterAtStart = timer.ElapsedMilliseconds; 
    for (int count = 0; count < 10000; count++) 
    { 
        count++; 
        count--; 
    } 
    Int64 counterAtEnd = timer.ElapsedMilliseconds;
    Int64 timeElapsedInTicks = counterAtEnd - counterAtStart; 
    Int64 timeElapsedInTenthsOfMilliseconds = (timeElapsedInTicks*10)/timer.Frequency; 
