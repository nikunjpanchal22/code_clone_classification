    ...
    { 
        ...
        { 
            ...
            { 
                ...
                info.Add(new Info() { CreatedDateTime = findData.ftCreationTime.ToDateTime(), ModifiedDateTime = findData.ftLastWriteTime.ToDateTime(), IsDirectory = isDir, Path = fullpath }); 
            } while (FindNextFile(findHandle, out findData)); 
        } 
    } 
    finally 
