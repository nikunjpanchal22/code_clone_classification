...
int main (void) {
    char *personLast, *personFirst, *origin, *destination;
    printf ("Please enter passenger's last name: ");
    scanf ("%ms", & personLast);
    printf ("Please enter passenger's first name: ");
    scanf ("%ms", & personFirst);
    printf ("Which airport are you departing from? ");
    scanf ("%ms", & origin);
    printf ("Which airport will you be heading to? ");
    scanf ("%ms", & destination);
    printf ("SURNAME: %s FIRST NAME: %s SETTING OUT FROM: %s DESTINATION: %s\n", personLast, personFirst, origin, destination);
    free (personLast);
    free (personFirst);
    free (origin);
    free (destination);
