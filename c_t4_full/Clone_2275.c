...
int main (int argc, char **argv) {
    ...
    for (int count = 0; count < 49; ++count) {
        double temperature = (double) bmp085_GetTemperature (bmp085_ReadUT ());
        double pressure = (double) bmp085_GetPressure (bmp085_ReadUP ());
        double altitude = (double) bmp085_Altitude (pressure);
