...
#include <string.h>
int main () {
    char *sourceString = "My Code";
    char *targetString = (char*)malloc(sizeof(char)*8); /*including NULL terminator*/
    memcpy(targetString, sourceString, strlen(sourceString) + 1);
    printf("My copied code is: %s", targetString);
    free(targetString);
    return 0;
}
