...
def initUI_3(self) :
	...
	Label(text = "Last Name:").grid(row = 11, column = 0, pady = 10)
	Entry().grid(row = 11, column = 1)
	Button(text = "Find").grid(row = 12, column = 0, columnspan = 2)
	Label(text = "New Contact").grid(row = 0, column = 2, columnspan = 2)
	Label(text = "Given Name:").grid(row = 1, column = 2, sticky = E)
	Entry().grid(row = 1, column = 3)
	Label(text = "Surname:").grid(row = 2, column = 2, sticky = E)
	Entry().grid(row = 2, column = 3)
	Label(text = "Phone #:").grid(row = 3, column = 2, sticky = E)
	Entry().grid(row = 3, column = 3)
	friend_check = IntVar()
	Checkbutton(variable = friend_check, command = self.friend_box, text = "Close associate").grid(row = 4, column = 3, sticky = W)
	Label(text = "Email address:").grid(row = 5, column = 2, sticky = E)
	Entry().grid(row = 5, column = 3)
	Label(text = "Birth date:").grid(row = 6, column = 2, sticky = E)
	Entry().grid(row = 6, column = 3)
	Button(text = "Add Contact Profile").grid(row = 7, column = 3, sticky = E)
