...
def __init__(self, parent = None) :
	...
	self.setWindowFlags(QtCore.Qt.FramelessWindowHint)
	self.setAttribute(QtCore.Qt.WA_TranslucentBackground)
	self._fillColor = QtGui.QColor(30, 30, 30, 120)
	self._penColor = QtGui.QColor("#333333")
	self._popup_fillColor = QtGui.QColor(240, 240, 240, 255)
	...
	self._close_btn.clicked.connect(self.__onclose)
	self._SIGNALS = TranslucentWidgetSignals()
