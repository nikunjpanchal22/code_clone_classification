...
def __init__(self, parent) :
	mystyle = FNB.FNB_DROPDOWN_TABS_LIST | FNB.FNB_FF2 | FNB.FNB_SMART_TABS | FNB.FNB_X_ON_TAB
	super(MyFlatNotebook, self).__init__(parent, style = mystyle)
	self.textedit = wx.TextCtrl(self, value = "edit me", style = wx.TE_MULTILINE)
	self.red = wx.Panel(self)
	self.red.SetBackgroundColour(wx.RED)
	self.AddPage(self.textedit, "Text Editor")
	self.AddPage(self.red, "Red Panel")
