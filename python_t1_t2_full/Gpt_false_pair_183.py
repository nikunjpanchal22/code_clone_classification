def signal_handler(helloProcess, counterProcess, signum, frame) :
 ...
 def signal_handler(helloProcess, counterProcess, signum, frame) :
	...
	if signum == 17 :
		...
		signal(SIGCHLD, SIG_IGN)
		if helloProcess.is_alive() :
			print("Sending SIGKILL to helloProcess")
			os.kill(helloProcess.pid, signal.SIGKILL)
		if counterProcess.is_alive() :
			print("Sending SIGKILL to counterProcess")
			os.kill(counterProcess.pid, signal.SIGKILL)
		sys.exit(0)		
