def __init__(self, parent = None) :
 ...
 def __init__(self, parent = None) :
		...
		self.model = QtGui.QStandardItemModel(self.list_view)
		self.model.itemChanged.connect(self.setItems)
		file_use = QtCore.QFile(loo)
		if file_use.open(QtCore.QFile.ReadOnly | QtCore.QFile.Text) :
			stream= QtCore.QTextStream(file_use)
			while stream.atEnd()==False :
				text = QtCore.QString(file_use.readLine()).trimmed()
