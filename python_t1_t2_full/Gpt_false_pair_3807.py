...
def __init__(self, parent=None):
	...
	self.fillColor = QtGui.QColor(30, 30, 30, 120)
	self.penColor = QtGui.QColor("#333333")
	self.popup_fillColor = QtGui.QColor(200, 200, 200, 255)
	self.popup_penColor = QtGui.QColor(80, 80, 80, 255)
	self.close_btn = QtWidgets.QPushButton(self)
	...
	font.setItalic(True)
	self.close_btn.setFont(font)
	self.close_btn.setStyleSheet("background-color: rgb(255, 255, 255, 0)")
	self.close_btn.setFixedSize(27, 27)
	self.close_btn.clicked.connect(self._onclose)
	self.SIGNALS = TranslucentWidgetSignals()
