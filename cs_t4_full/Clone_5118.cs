public static bool IsWindowOnAnyScreen (Window Window, short WindowSizeX, short WindowSizeY, bool AutoAdjustWindow) {
 ...
 public static bool IsWindowOnAnyScreen (Window Window, short WindowSizeX, short WindowSizeY, bool AutoAdjustWindow) {
    ...
    if (AutoAdjustWindow) {
        ...
        if (Window.Left + WindowSizeX > Screen.WorkingArea.Right) Window.Left = Screen.WorkingArea.Right - WindowSizeX;
        if (Window.Top + WindowSizeY > Screen.WorkingArea.Bottom) Window.Top = Screen.WorkingArea.Bottom - WindowSizeY;
    }
