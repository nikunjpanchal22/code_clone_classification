 ...
 public static DateTime AddBusinessDays(this DateTime date, int days)
    {
        ...
        //If day is Sunday and remainder > 0 decrement weekday
        if(dayOfWeek == 0 && remainder > 0)
            remainder -= 1;
        //If weekday + remainder > 5 then increment weekday
        else if(dayOfWeek + remainder > 5)
            remainder += 2;
 
        //Add remainder to date
        date = date.AddDays(remainder);
        return date;
    }
 ...
 public static DateTime AddBusinessDays(this DateTime date, int days)
{
 ...
 public static DateTime AddBusinessDays(this DateTime date, int days) {
    ...
    //Case statement to determine day of the week
    switch (dayOfWeek)
    {
        case DayOfWeek.Monday:
            if (remainder >4)
