 ...
 private void button1_Click (object sender, EventArgs e) {
    if (textBox1.Text.Length != 0) {
        ...
        if (names.Length > 1) {
            ...
            string conStr = @"Data Source=C:\Users\Andrei\Documents\Visual Studio 2010\Projects\Stellwag\Stellwag\Angajati.sdf";
            using (SqlCeConnection cn = new SqlCeConnection(conStr))
            {
            }}
    }
}
