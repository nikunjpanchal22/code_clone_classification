...
{ 
    ...
    {
        foreach( DictionaryEntry entry in (System.Collections.IDictionary) value ) 
        {
    ...
    {
        System.Collections.IEnumerator enumerator = (value as System.Collections.IEnumerable).GetEnumerator();
        int index = 0;
