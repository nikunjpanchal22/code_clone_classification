 ...
 public override bool Equals(object obj)
{
    ...
    if (CanCompareBits(this) && FastEqualsCheck(this, obj)) 
    {
        return true;
    }
    ...
    {
        object thisValue = ((RtFieldInfo)field).UnsafeGetValue(this);
        object objValue = ((RtFieldInfo)field).UnsafeGetValue(obj);
        ...
        else if (!thisValue.Equals(objValue))
        {
            return false;
        }
    }
