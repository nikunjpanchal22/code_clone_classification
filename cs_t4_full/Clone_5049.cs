public static string Format (this TimeSpan obj) {
 ...
 public static string Format (this TimeSpan obj) { 
    ...
    if (hour > 0) {
        sb.Append (hour); 
        sb.Append (obj.Hours < 0 ? " negative-hours" : " hours"); 
        sb.Append (" "); 
    }
    int minutes = Math.Abs(obj.Minutes);
    if (minutes > 0 || sb.Length != 0) {
        sb.Append (minutes);
        sb.Append (obj.Minutes < 0 ? " negative-minutes" : " minutes");
        sb.Append (" ");
    }
    int seconds = Math.Abs(obj.Seconds);
    if (seconds > 0 || sb.Length != 0) {
        sb.Append (seconds);
        sb.Append (obj.Seconds < 0 ? " negative-seconds" : " seconds");
        sb.Append (" "); 
    }
    int milliseconds = Math.Abs(obj.Milliseconds);
    if (milliseconds > 0 || sb.Length != 0) {
        sb.Append (milliseconds);
        sb.Append (obj.Milliseconds < 0 ? " negative-milliseconds" : " milliseconds");
        sb.Append (" ");
    }
    if (sb.Length == 0) {
        sb.Append (0);
