...
private Coordinate Calculate(Coordinate location1, Coordinate location2, Coordinate location3, Coordinate location4){    
    ...
    do {
        randomCoordinate = new Coordinate(){Latitude = (int) (Math.random() * (maxLatitude - minLatitude) + minLatitude)};
    ...
    randomCoordinate.Longitude = (int) (Math.random() * (maxLongitude - minLongitude) + minLongitude);
    return randomCoordinate;
}
