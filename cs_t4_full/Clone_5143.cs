 ...
 protected Dictionary<DateTime, String> getDateRange(String lowerDate, String higherDate, String frequency){
    ...
    while (startDate < endDate)
    {
        if(frequency.Equals("weekly"))
        {
            ...
            returnDict.Add(startDate, startDate.ToString("dd/MM/yyyy") + " -- " + tempDate.ToString("dd/MM/yyyy"));
            startDate = tempDate.AddDays(1);
        }
        else if(frequency.Equals("monthly"))
        {
            tempDate = startDate.AddMonths(1);
            returnDict.Add(startDate, startDate.ToString("MMMM yyyy") + " -- " + tempDate.ToString("MMMM yyyy"));
            startDate = tempDate.AddDays(1);
        }
    }
    ...
    {
        returnDict.Add( startDate, startDate.ToString("dd/MM/yyyy") + " -- " + endDate.ToString("dd/MM/yyyy"));
    }
    return returnDict;   
}
