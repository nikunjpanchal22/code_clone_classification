private void button3_Click (object sender, RoutedEventArgs e) {
  ...
  private void button3_Click (object sender, RoutedEventArgs e) {
    var firstVisibleItem = GetFirstVisibleItem (listBox1);
    listBox1.Items.Add("item16");
    listBox1.Items.Add("item17");
    listBox1.Items.Add("item18");
    listBox1.Items.Add("item19");
    listBox1.Items.Add("item20");
    listBox1.Items.Add("item21");
    listBox1.Items.Add("item22");
    listBox1.Items.Add("item23");
    listBox1.Items.Add("item24");
    if (firstVisibleItem != null) {
        Application.Current.Dispatcher.BeginInvoke (DispatcherPriority.Loaded, new Action (delegate () {
            listBox1.ScrollIntoView (firstVisibleItem);
        }));
    }
}
