def __init__(self, rect, pen, brush, tooltip = 'No tip here', parent = None) :
    ...
    self.focusrect = QtCore.QRectF(rect[0] - pen_width, rect[1] - pen_width, rect[2] + pen_width, rect[3] + pen_width)




def __init__(self, rect, pen, brush, tooltip = 'Hover over the object', parent = None) :
