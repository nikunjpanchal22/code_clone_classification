def __init__(self, parent = None) :
	...
	self.close_button.clicked.connect(self._onclose)
	self.EVENTS = WidgetSignals()
...
def __init__(self, parent = None) :
	...
	self.setWindowFlags(QtCore.Qt.FramelessWindowHint)
	self.setAttribute(QtCore.Qt.WA_TranslucentBackground)
	self.bgColor = QtGui.QColor(180, 180, 180, 80)
	self.borderLine_color = QtGui.QColor("#B1B1B1")
