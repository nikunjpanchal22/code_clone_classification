def __init__(self, rect, pen, brush, tooltip = 'No tip here', parent = None) :
    ...
    self.focusrect = self.rect.adjusted(-self.pen.widthF() / 2, -self.pen.widthF() / 2, self.pen.widthF(), self.pen.widthF())




def __init__(self, rect, pen, brush, tooltip = 'No Tooltip info', parent = None) :
