def __init__(self, rect, pen, brush, tooltip = 'No tip here', parent = None) :
    ...
    self.brush = QtGui.QBrush(QtCore.Qt.cyan)
    self.rect = QtCore.QRectF(rect[0] - pw / 2, rect[1] - pw / 2, rect[2] + pw, rect[3] + pw)
    self.focusrect = self.rect.adjusted(-pw / 2, -pw / 2, pw, pw)




def __init__(self, rect, pen, brush, tooltip = 'No tip available', parent = None):
